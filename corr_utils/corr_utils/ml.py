...
def get_eda_metrics(X_train:torch.Tensor, X_test:torch.Tensor, y_train:torch.Tensor, y_test:torch.Tensor, variables:list, outcome:str) -> None:
    ...
    Parameters:
        X_train (torch.Tensor): The features for training.
        X_test (torch.Tensor): The features for testing.
        y_train (torch.Tensor): The lables for training.
        y_test (torch.Tensor): The lables for testing.
...
def get_class_weights(y_train:torch.Tensor, show:bool=False):
    ...
    # class weights as the inverse of class frequency (reference: https://medium.com/@ravi.abhinav4/improving-class-imbalance-with-class-weights-in-machine-learning-af072fdd4aa4)
...
def train(X_train:torch.Tensor, y_train:torch.Tensor, model:NeuralNetwork, criterion, optimizer, epochs:int=100) -> None:
    ...
    Parameters:
        X_train (torch.Tensor): The features for training.
        y_train (torch.Tensor): The labels for training.
        model (NeuralNetwork): The neural network model.
        criterion: The loss function.
        optimizer: The optimizer for gradient descent.
